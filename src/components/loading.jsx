...
//   /* This kills the GHOST: It gives the wrapper a physical size */
//   width: 96px;
//   height: 96px;
//   display: flex;
//   align-items: center;
...
//     margin: 2px;
//     background: white;
//     /* Reduced duration for better visibility during testing, 
//        feel free to change back to 10s */
//     animation: square-animation 8s ease-in-out infinite both;
//   }

//   /* nth-of-type is 1-indexed. Starting from 1 ensures all squares move */
//   .loader-square:nth-of-type(1) { animation-delay: 0s; }
//   .loader-square:nth-of-type(2) { animation-delay: -1.14s; }
//   .loader-square:nth-of-type(3) { animation-delay: -2.28s; }
//   .loader-square:nth-of-type(4) { animation-delay: -3.42s; }
//   .loader-square:nth-of-type(5) { animation-delay: -4.57s; }
//   .loader-square:nth-of-type(6) { animation-delay: -5.71s; }
//   .loader-square:nth-of-type(7) { animation-delay: -6.85s; }
// `;
      ...
      <div className="svg-container">
        <svg id="svg-global" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 94 136" height={136} width={94}>
          ...
          <g id="node-server">
            ...
            <mask height={41} width={67} y={50} x={13} maskUnits="userSpaceOnUse" id="mask0_204_217">
            ...
            <g mask="url(#mask0_204_217)">
              ...
              <mask height={29} width={48} y={56} x={23} maskUnits="userSpaceOnUse" id="mask1_204_217">
          ...
          <g id="panel-rigth">
            ...
            <path fill="#91DDFB" d="M67 94.6603C67 93.3848 67.8954 91.8339 69 91.1962V91.1962C70.1046 90.5584 71 92.3509V92.5129C71 93.7884 70.1046 95.3393 69 95.977V95.977C67.8954 96.6147 67 96.0978 67 94.8223V94.6603Z" />
...
const StyledWrapper = styled.div`
  /* CENTER THE LOADER WITHIN ITSELF */
  width: 100%;
  height: 100%;
  display: flex;
  align-items: center;
  ...
  .svg-container {
    ...
    align-items: center;
    justify-content: center;
    transform: scale(1.5); /* Boosted size slightly for better UX */
  }

...
export default function Login(){
   ...
   const handelChange=(e)=>{
    ...
    Login To Your Account
            ...
            <form className="flex grid  flex-col-4 gap-1">
                <input placeholder="username" onChange={handelChange} className="text-white p-2 m-2 border border-gray-600 rounded hover:scale-103 hover:brightness-120" />
                <input placeholder="password" onChange={handelChange} className="text-white p-2 m-2 border border-gray-600 rounded hover:scale-103 hover:brightness-120" />
